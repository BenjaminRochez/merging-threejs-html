...
## Implementing other effects
Once we've got the structure in place, it's pretty straight forward to implement other effects found online (https://tympanus.net/Development/webGLImageTransitions/index2.html)
